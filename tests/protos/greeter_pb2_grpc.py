...
from tests.protos import greeter_pb2 as greeter__pb2
...
class GreeterStub:
    ...
    def __init__(self, channel):
        ...
        self.SayHelloServerStream = channel.unary_stream(
                '/greeter.Greeter/SayHelloServerStream',
                request_serializer=greeter__pb2.HelloRequest.SerializeToString,
                response_deserializer=greeter__pb2.HelloReply.FromString,
                _registered_method=True)
        self.SayHelloClientStream = channel.stream_unary(
                ...
                response_deserializer=greeter__pb2.HelloReply.FromString,
                _registered_method=True)
        self.SayHelloBidi = channel.stream_stream(
                '/greeter.Greeter/SayHelloBidi',
                request_serializer=greeter__pb2.HelloRequest.SerializeToString,
                response_deserializer=greeter__pb2.HelloReply.FromString,
                _registered_method=True)
...
class GreeterServicer:
    ...
    def SayHelloBidi(self, request_iterator, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SayHelloBidi': grpc.stream_stream_rpc_method_handler(
                    servicer.SayHelloBidi,
                    request_deserializer=greeter__pb2.HelloRequest.FromString,
                    response_serializer=greeter__pb2.HelloReply.SerializeToString,
            ),
    }
...
class Greeter:
    ...
    @staticmethod
    def SayHelloBidi(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
